...
@section('content')
	...
	<div class="slider">
		<ul class="slides">
			<li>
				<img src="/mstore/img/slide1.jpg" alt="">
			...
			<li>
				<img src="/mstore/img/slide2.jpg" alt="">
				<div class="caption slider-content center-align">
			...
			<li>
				<img src="/mstore/img/slide3.jpg" alt="">
				<div class="caption slider-content center-align">
					<h2>FASHION SHOP</h2>
					<h4>Lorem ipsum dolor sit amet.</h4>
					<a href="" class="btn button-default">SHOP NOW</a>
			...
			<div class="row">
				<div class="col s6">
					<div class="content">
						...
						<div class="price">
						¥{{$v->goods_markprice}}<span>¥{{$v->goods_markprice*1.3}}</span>
						</div>
						<a class="btn button-default"  href="cartadd?goods_id={{$v->goods_id}}">添加到购物车</a>
					</div>
				</div>
			</div>
			@endforeach
